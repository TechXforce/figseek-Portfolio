...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Content - Shifted up 3 space-buttons */}
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center" style={{ marginTop: '-3rem' }}>
        <h1 className="text-5xl md:text-9xl font-bold mb-4 min-h-[60px] md:min-h-[160px]">
          <span className="bg-gradient-to-r from-white via-blue-400 to-purple-500 bg-clip-text text-transparent ml-0 md:ml-4">
            {displayedText.name}
          </span>
        </h1>

        <div className="mb-4 min-h-[80px] md:min-h-[160px]">
          <p className="text-lg md:text-3xl text-gray-300 mb-3 min-h-[30px] md:min-h-[40px]">
            {displayedText.title}
      ...
      >
        <ChevronDown className="w-7 h-7 md:w-8 md:h-8 text-blue-400" />
      </motion.div>
    </section>
  );
}